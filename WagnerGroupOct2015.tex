...
\begin{columns}
    \begin{column}{\textwidth}
        \hspace{6cm} \includegraphics[height=6cm,width=6cm]{./tissueskinds.png}
    \end{column}
    \begin{column}{0.8\textwidth}
        \hspace{7cm} \includegraphics[height=2cm,width=2cm]{./drosophila.jpg}
        \hspace{7cm} \includegraphics[height=2cm,width=2cm]{./hydra.jpg}
        \hspace{7cm} \includegraphics[height=2cm,width=2cm]{./xenopus.jpg}
    \end{column}
\end{columns}
\end{minipage}
\end{beamerboxesrounded}
...
%%tissue growth remarks
\frame{\frametitle{Different Developmental stages (Drosophila wings)}
\setbeamercolor{uppercol}{fg=black,bg=pink}
\setbeamercolor{lowercol}{fg=black,bg=pink}
...
\begin{columns}
    \begin{column}{\textwidth}
        \hspace{6.5cm}\includegraphics[height=6cm]{./junctionalnetwork.png}
    \end{column}
    \begin{column}{0.8\textwidth}
        \begin{itemize}
...
\begin{columns}
    ...
    \begin{column}{0.8\textwidth}
        \begin{enumerate}
        \item < 1-| alert@1 > \textbf{Relaxation} (Vertices change their position to guarantee the force balance to be equal to zero).
        \item < 2-| alert@1 > \textbf{Cell Proliferation} (cells growth and cells division).
        \end{enumerate}
    \end{column}
\end{columns}
\end{minipage}
...
\begin{columns}
    \begin{column}{\textwidth}
        \begin{center}
            $Reg ~ \apeq ~ 0$
            $(Lambda,Gamma) = (-0.25,0.15)$
        \end{center}
        \hspace{1cm}\flashmovie[auto=1,loop=1,controlbar=1,engine=flv-player,width=5cm,height=5cm]{regular_relaxation.flv}
    \end{column}
    \begin{column}{\textwidth}
        \begin{center}
            $Reg ~ > ~ 0$
            $(Lambda,Gamma) = (-0.6,0.08)$
        \end{center}
        \hspace{1cm}\flashmovie[auto=1,loop=1,controlbar=1,engine=flv-player,width=5cm,height=5cm]{soft_relaxation.flv}
    \end{column}
\end{columns}
\end{minipage}
\end{beamerboxesrounded}
...
\begin{columns}
    \begin{column}{\textwidth}
        \begin{center}
            ...
            $(Lambda,Gamma) = (0,0.15)$
        \end{center}
        \hspace{1cm}\flashmovie[auto=1,loop=1,controlbar=1,engine=flv-player,width=5cm,height=5cm]{shapedistribution1.flv}
    \end{column}
    \begin{column}{\textwidth}
        \begin{center}
            $Reg ~ > ~ 0$
            $(Lambda,Gamma) = (-0.6,0.08)$
        \end{center}
        \hspace{1cm}\flashmovie[auto=1,loop=1,controlbar=1,engine=flv-player,width=5cm,height=5cm]{shapedistribution2.flv}
    \end{column}
\end{columns}
\end{minipage}
}
...
\setbeamercolor{uppercol}{fg=black,bg=pink}
\setbeamercolor{lowercol}{fg=black,bg=pink}
We observed the following Phase space of shape of cells after 10 replicates.
\centering \includegraphics[width=8cm]{levelplot_mean_cellshape.png}
}
