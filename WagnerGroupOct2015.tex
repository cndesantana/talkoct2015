...
\begin{columns}
    ...
    \begin{column}{0.8\textwidth}
        \begin{itemize}
        \item 4 - Relaxation is finished once the length of the tissue remains \emph{steady} (the position of its vertices don't change) along 100 time steps ($\frac{sd(\sum_{\alpha}{L_{\alpha}})}{\bar{\sum_{\alpha}{L_{\alpha}}}} \apeq 0 $).
        \end{itemize}
    \end{column}
\end{columns}
\end{minipage}
